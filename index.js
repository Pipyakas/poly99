...
// end include: /tmp/tmpg26xzz5g.js
// include: /tmp/tmp32r08mb8.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp32r08mb8.js
// include: /tmp/tmpyiexkkpv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpyiexkkpv.js
...
var ASM_CONSTS = {
 ...
 103967: () => { if (window.__poly99GL) return; var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); if (!gl) return; var ext2 = gl.getExtension('EXT_disjoint_timer_query_webgl2'); if (ext2) { window.__poly99GL = gl; window.__poly99EXT = ext2; window.__poly99WEBGL2 = true; return; } var ext1 = gl.getExtension('EXT_disjoint_timer_query'); if (ext1) { window.__poly99GL = gl; window.__poly99EXT = ext1; window.__poly99WEBGL2 = false; } },  
 104437: ($0, $1) => { var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); var name = 'n/a'; if (gl) { var dbg = gl.getExtension('WEBGL_debug_renderer_info'); if (dbg) name = gl.getParameter(dbg.UNMASKED_RENDERER_WEBGL) || 'n/a'; } stringToUTF8(name, $0, $1); },  
 104726: () => { return (typeof performance !== 'undefined' && performance.memory) ? performance.memory.usedJSHeapSize : 0; },  
 104837: () => { return HEAPU8.length; },  
 104863: () => { var gl = window.__poly99GL; var ext = window.__poly99EXT; if (!gl || !ext || !window.__poly99Q) return -1; if (window.__poly99WEBGL2) { if (gl.getQueryParameter(window.__poly99Q, ext.QUERY_RESULT_AVAILABLE_EXT)) { var ns = gl.getQueryParameter(window.__poly99Q, ext.QUERY_RESULT_EXT); gl.deleteQuery(window.__poly99Q); window.__poly99Q = null; return ns / 1000000.0; } } else { if (ext.getQueryParameterEXT(window.__poly99Q, ext.QUERY_RESULT_AVAILABLE_EXT)) { var ns = ext.getQueryParameterEXT(window.__poly99Q, ext.QUERY_RESULT_EXT); ext.deleteQueryEXT(window.__poly99Q); window.__poly99Q = null; return ns / 1000000.0; } } return -1; },  
 105503: () => { var gl = window.__poly99GL; var ext = window.__poly99EXT; if (!gl || !ext || window.__poly99Q) return; if (window.__poly99WEBGL2) { window.__poly99Q = gl.createQuery(); gl.beginQuery(ext.TIME_ELAPSED_EXT, window.__poly99Q); } else { window.__poly99Q = ext.createQueryEXT(); ext.beginQueryEXT(ext.TIME_ELAPSED_EXT, window.__poly99Q); } },  
 105842: () => { var gl = window.__poly99GL; var ext = window.__poly99EXT; if (!gl || !ext || !window.__poly99Q) return; if (window.__poly99WEBGL2) gl.endQuery(ext.TIME_ELAPSED_EXT); else ext.endQueryEXT(ext.TIME_ELAPSED_EXT); },  
 106056: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 108234: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 108538: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 108642: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 108813: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 111690: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 111763: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 112163: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 112213: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 112352: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 112492: () => { if (document.fullscreenElement) return 1; },  
 112538: () => { return Module.canvas.width; },  
 112570: () => { return parseInt(Module.canvas.style.width); },  
 112618: () => { document.exitFullscreen(); },  
 112645: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 112717: () => { if (document.fullscreenElement) return 1; },  
 112763: () => { return Module.canvas.width; },  
 112795: () => { return screen.width; },  
 112820: () => { document.exitFullscreen(); },  
 112847: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 113041: () => { return window.innerWidth; },  
 113067: () => { return window.innerHeight; },  
 113094: () => { if (document.fullscreenElement) return 1; },  
 113140: () => { return Module.canvas.width; },  
 113172: () => { return parseInt(Module.canvas.style.width); },  
 113220: () => { if (document.fullscreenElement) return 1; },  
 113266: () => { return Module.canvas.width; },  
 113298: () => { return screen.width; },  
 113323: () => { return window.innerWidth; },  
 113349: () => { return window.innerHeight; },  
 113376: () => { if (document.fullscreenElement) return 1; },  
 113422: () => { return Module.canvas.width; },  
 113454: () => { return screen.width; },  
 113479: () => { document.exitFullscreen(); },  
 113506: () => { if (document.fullscreenElement) return 1; },  
 113552: () => { return Module.canvas.width; },  
 113584: () => { return parseInt(Module.canvas.style.width); },  
 113632: () => { document.exitFullscreen(); },  
 113659: ($0) => { Module.canvas.style.opacity = $0; },  
 113697: () => { return screen.width; },  
 113722: () => { return screen.height; },  
 113748: () => { return window.screenX; },  
 113775: () => { return window.screenY; },  
 113802: () => { return window.devicePixelRatio; },  
 113838: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113891: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 113942: () => { Module.canvas.style.cursor = 'none'; },  
 113979: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114235: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114286: () => { if (document.pointerLockElement) return 1; },  
 114333: () => { if (document.fullscreenElement) return 1; },  
 114379: () => { return window.innerWidth; },  
 114405: () => { return window.innerHeight; }
};

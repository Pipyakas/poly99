...
var ASM_CONSTS = {
  87008: () => { return window.innerWidth; },  
 87038: () => { return window.innerHeight; },  
 87069: () => { if (document.fullscreenElement) return 1; },  
 87115: () => { return Module.canvas.width; },  
 87147: () => { return parseInt(Module.canvas.style.width); },  
 87195: () => { document.exitFullscreen(); },  
 87222: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 87294: () => { if (document.fullscreenElement) return 1; },  
 87340: () => { return Module.canvas.width; },  
 87372: () => { return screen.width; },  
 87397: () => { document.exitFullscreen(); },  
 87424: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 87618: () => { return window.innerWidth; },  
 87644: () => { return window.innerHeight; },  
 87671: () => { if (document.fullscreenElement) return 1; },  
 87717: () => { return Module.canvas.width; },  
 87749: () => { return parseInt(Module.canvas.style.width); },  
 87797: () => { if (document.fullscreenElement) return 1; },  
 87843: () => { return Module.canvas.width; },  
 87875: () => { return screen.width; },  
 87900: () => { return window.innerWidth; },  
 87926: () => { return window.innerHeight; },  
 87953: () => { if (document.fullscreenElement) return 1; },  
 87999: () => { return Module.canvas.width; },  
 88031: () => { return screen.width; },  
 88056: () => { document.exitFullscreen(); },  
 88083: () => { if (document.fullscreenElement) return 1; },  
 88129: () => { return Module.canvas.width; },  
 88161: () => { return parseInt(Module.canvas.style.width); },  
 88209: () => { document.exitFullscreen(); },  
 88236: ($0) => { Module.canvas.style.opacity = $0; },  
 88274: () => { return screen.width; },  
 88299: () => { return screen.height; },  
 88325: () => { return window.screenX; },  
 88352: () => { return window.screenY; },  
 88379: () => { return window.devicePixelRatio; },  
 88415: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 88468: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88519: () => { Module.canvas.style.cursor = 'none'; },  
 88556: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 88812: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88863: () => { if (document.pointerLockElement) return 1; },  
 88910: () => { if (document.fullscreenElement) return 1; },  
 88956: () => { return window.innerWidth; },  
 88982: () => { return window.innerHeight; }
};

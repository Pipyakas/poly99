...
var ASM_CONSTS = {
  86992: () => { return window.innerWidth; },  
 87022: () => { return window.innerHeight; },  
 87053: () => { if (document.fullscreenElement) return 1; },  
 87099: () => { return Module.canvas.width; },  
 87131: () => { return parseInt(Module.canvas.style.width); },  
 87179: () => { document.exitFullscreen(); },  
 87206: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 87278: () => { if (document.fullscreenElement) return 1; },  
 87324: () => { return Module.canvas.width; },  
 87356: () => { return screen.width; },  
 87381: () => { document.exitFullscreen(); },  
 87408: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 87602: () => { return window.innerWidth; },  
 87628: () => { return window.innerHeight; },  
 87655: () => { if (document.fullscreenElement) return 1; },  
 87701: () => { return Module.canvas.width; },  
 87733: () => { return parseInt(Module.canvas.style.width); },  
 87781: () => { if (document.fullscreenElement) return 1; },  
 87827: () => { return Module.canvas.width; },  
 87859: () => { return screen.width; },  
 87884: () => { return window.innerWidth; },  
 87910: () => { return window.innerHeight; },  
 87937: () => { if (document.fullscreenElement) return 1; },  
 87983: () => { return Module.canvas.width; },  
 88015: () => { return screen.width; },  
 88040: () => { document.exitFullscreen(); },  
 88067: () => { if (document.fullscreenElement) return 1; },  
 88113: () => { return Module.canvas.width; },  
 88145: () => { return parseInt(Module.canvas.style.width); },  
 88193: () => { document.exitFullscreen(); },  
 88220: ($0) => { Module.canvas.style.opacity = $0; },  
 88258: () => { return screen.width; },  
 88283: () => { return screen.height; },  
 88309: () => { return window.screenX; },  
 88336: () => { return window.screenY; },  
 88363: () => { return window.devicePixelRatio; },  
 88399: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 88452: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88503: () => { Module.canvas.style.cursor = 'none'; },  
 88540: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 88796: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88847: () => { if (document.pointerLockElement) return 1; },  
 88894: () => { if (document.fullscreenElement) return 1; },  
 88940: () => { return window.innerWidth; },  
 88966: () => { return window.innerHeight; }
};

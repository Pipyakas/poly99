...
var ASM_CONSTS = {
  87024: () => { return window.innerWidth; },  
 87054: () => { return window.innerHeight; },  
 87085: () => { if (document.fullscreenElement) return 1; },  
 87131: () => { return Module.canvas.width; },  
 87163: () => { return parseInt(Module.canvas.style.width); },  
 87211: () => { document.exitFullscreen(); },  
 87238: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 87310: () => { if (document.fullscreenElement) return 1; },  
 87356: () => { return Module.canvas.width; },  
 87388: () => { return screen.width; },  
 87413: () => { document.exitFullscreen(); },  
 87440: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 87634: () => { return window.innerWidth; },  
 87660: () => { return window.innerHeight; },  
 87687: () => { if (document.fullscreenElement) return 1; },  
 87733: () => { return Module.canvas.width; },  
 87765: () => { return parseInt(Module.canvas.style.width); },  
 87813: () => { if (document.fullscreenElement) return 1; },  
 87859: () => { return Module.canvas.width; },  
 87891: () => { return screen.width; },  
 87916: () => { return window.innerWidth; },  
 87942: () => { return window.innerHeight; },  
 87969: () => { if (document.fullscreenElement) return 1; },  
 88015: () => { return Module.canvas.width; },  
 88047: () => { return screen.width; },  
 88072: () => { document.exitFullscreen(); },  
 88099: () => { if (document.fullscreenElement) return 1; },  
 88145: () => { return Module.canvas.width; },  
 88177: () => { return parseInt(Module.canvas.style.width); },  
 88225: () => { document.exitFullscreen(); },  
 88252: ($0) => { Module.canvas.style.opacity = $0; },  
 88290: () => { return screen.width; },  
 88315: () => { return screen.height; },  
 88341: () => { return window.screenX; },  
 88368: () => { return window.screenY; },  
 88395: () => { return window.devicePixelRatio; },  
 88431: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 88484: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88535: () => { Module.canvas.style.cursor = 'none'; },  
 88572: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 88828: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88879: () => { if (document.pointerLockElement) return 1; },  
 88926: () => { if (document.fullscreenElement) return 1; },  
 88972: () => { return window.innerWidth; },  
 88998: () => { return window.innerHeight; }
};

...
// end include: /tmp/tmp7i5ubrqo.js
// include: /tmp/tmpe3u7om2w.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpe3u7om2w.js
// include: /tmp/tmp3ijrusux.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp3ijrusux.js
...
var ASM_CONSTS = {
 ...
 108458: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 108508: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 108647: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 108787: () => { if (document.fullscreenElement) return 1; },  
 108833: () => { return Module.canvas.width; },  
 108865: () => { return parseInt(Module.canvas.style.width); },  
 108913: () => { document.exitFullscreen(); },  
 108940: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 109012: () => { if (document.fullscreenElement) return 1; },  
 109058: () => { return Module.canvas.width; },  
 109090: () => { return screen.width; },  
 109115: () => { document.exitFullscreen(); },  
 109142: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 109336: () => { return window.innerWidth; },  
 109362: () => { return window.innerHeight; },  
 109389: () => { if (document.fullscreenElement) return 1; },  
 109435: () => { return Module.canvas.width; },  
 109467: () => { return parseInt(Module.canvas.style.width); },  
 109515: () => { if (document.fullscreenElement) return 1; },  
 109561: () => { return Module.canvas.width; },  
 109593: () => { return screen.width; },  
 109618: () => { return window.innerWidth; },  
 109644: () => { return window.innerHeight; },  
 109671: () => { if (document.fullscreenElement) return 1; },  
 109717: () => { return Module.canvas.width; },  
 109749: () => { return screen.width; },  
 109774: () => { document.exitFullscreen(); },  
 109801: () => { if (document.fullscreenElement) return 1; },  
 109847: () => { return Module.canvas.width; },  
 109879: () => { return parseInt(Module.canvas.style.width); },  
 109927: () => { document.exitFullscreen(); },  
 109954: ($0) => { Module.canvas.style.opacity = $0; },  
 109992: () => { return screen.width; },  
 110017: () => { return screen.height; },  
 110043: () => { return window.screenX; },  
 110070: () => { return window.screenY; },  
 110097: () => { return window.devicePixelRatio; },  
 110133: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110186: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 110237: () => { Module.canvas.style.cursor = 'none'; },  
 110274: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110530: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 110581: () => { if (document.pointerLockElement) return 1; },  
 110628: () => { if (document.fullscreenElement) return 1; },  
 110674: () => { return window.innerWidth; },  
 110700: () => { return window.innerHeight; }
};

...
// end include: /tmp/tmp8e899jq8.js
// include: /tmp/tmp1xlhar6s.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1xlhar6s.js
// include: /tmp/tmpc0o9i896.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpc0o9i896.js
...
var ASM_CONSTS = {
  101836: () => { return window.innerWidth; },  
 101866: () => { return window.innerHeight; },  
 101897: () => { if (typeof localStorage === 'undefined') return -1; var s = localStorage.getItem('poly99_touch'); if (s === null || s === '') return -1; return parseInt(s, 10) ? 1 : 0; },  
 102070: () => { var ua = navigator.userAgent || ''; if (navigator.maxTouchPoints > 0 || ('ontouchstart' in window) || (ua.indexOf('Android') >= 0)) return 1; return 0; },  
 102226: ($0) => { if (typeof localStorage !== 'undefined') { localStorage.setItem('poly99_touch', $0 ? '1' : '0'); } },  
 102329: ($0, $1) => { if (typeof localStorage === 'undefined') return $1; var v = localStorage.getItem(UTF8ToString($0)); return (v === null || v === '') ? $1 : parseFloat(v); },  
 102487: ($0, $1) => { if (typeof localStorage === 'undefined') return $1; var v = localStorage.getItem(UTF8ToString($0)); return (v === null || v === '') ? $1 : parseInt(v, 10); },  
 102647: ($0, $1) => { if (typeof localStorage !== 'undefined') localStorage.setItem(UTF8ToString($0), $1.toString()); },  
 102747: ($0, $1) => { if (typeof localStorage !== 'undefined') localStorage.setItem(UTF8ToString($0), $1.toString()); },  
 102847: ($0, $1) => { var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); var name = 'n/a'; if (gl) { var dbg = gl.getExtension('WEBGL_debug_renderer_info'); if (dbg) name = gl.getParameter(dbg.UNMASKED_RENDERER_WEBGL) || 'n/a'; } stringToUTF8(name, $0, $1); },  
 103136: () => { return (typeof performance !== 'undefined' && performance.memory) ? performance.memory.usedJSHeapSize : 0; },  
 103247: () => { return HEAPU8.length; },  
 103273: () => { var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); if (!gl) return -1; var ext = gl.getExtension('EXT_disjoint_timer_query') || gl.getExtension('EXT_disjoint_timer_query_webgl2'); if (!ext || !window.__poly99Q) return -1; if (gl.getQueryParameter(window.__poly99Q, ext.QUERY_RESULT_AVAILABLE_EXT)) { var ns = gl.getQueryParameter(window.__poly99Q, ext.QUERY_RESULT_EXT); gl.deleteQuery(window.__poly99Q); window.__poly99Q = null; return ns / 1000000.0; } return -1; },  
 103792: () => { var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); if (!gl) return; var ext = gl.getExtension('EXT_disjoint_timer_query') || gl.getExtension('EXT_disjoint_timer_query_webgl2'); if (!ext) return; if (window.__poly99Q) return; window.__poly99Q = gl.createQuery(); gl.beginQuery(ext.TIME_ELAPSED_EXT, window.__poly99Q); },  
 104162: () => { var gl = Module.ctx || (typeof GL !== 'undefined' && GL.currentContext && GL.currentContext.GLctx); if (!gl) return; var ext = gl.getExtension('EXT_disjoint_timer_query') || gl.getExtension('EXT_disjoint_timer_query_webgl2'); if (!ext || !window.__poly99Q) return; gl.endQuery(ext.TIME_ELAPSED_EXT); },  
 ...
 106644: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 106948: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 107052: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 107223: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 110100: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 110173: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 110573: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 110623: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 110762: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 110902: () => { if (document.fullscreenElement) return 1; },  
 110948: () => { return Module.canvas.width; },  
 110980: () => { return parseInt(Module.canvas.style.width); },  
 111028: () => { document.exitFullscreen(); },  
 111055: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 111127: () => { if (document.fullscreenElement) return 1; },  
 111173: () => { return Module.canvas.width; },  
 111205: () => { return screen.width; },  
 111230: () => { document.exitFullscreen(); },  
 111257: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 111451: () => { return window.innerWidth; },  
 111477: () => { return window.innerHeight; },  
 111504: () => { if (document.fullscreenElement) return 1; },  
 111550: () => { return Module.canvas.width; },  
 111582: () => { return parseInt(Module.canvas.style.width); },  
 111630: () => { if (document.fullscreenElement) return 1; },  
 111676: () => { return Module.canvas.width; },  
 111708: () => { return screen.width; },  
 111733: () => { return window.innerWidth; },  
 111759: () => { return window.innerHeight; },  
 111786: () => { if (document.fullscreenElement) return 1; },  
 111832: () => { return Module.canvas.width; },  
 111864: () => { return screen.width; },  
 111889: () => { document.exitFullscreen(); },  
 111916: () => { if (document.fullscreenElement) return 1; },  
 111962: () => { return Module.canvas.width; },  
 111994: () => { return parseInt(Module.canvas.style.width); },  
 112042: () => { document.exitFullscreen(); },  
 112069: ($0) => { Module.canvas.style.opacity = $0; },  
 112107: () => { return screen.width; },  
 112132: () => { return screen.height; },  
 112158: () => { return window.screenX; },  
 112185: () => { return window.screenY; },  
 112212: () => { return window.devicePixelRatio; },  
 112248: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112301: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 112352: () => { Module.canvas.style.cursor = 'none'; },  
 112389: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112645: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 112696: () => { if (document.pointerLockElement) return 1; },  
 112743: () => { if (document.fullscreenElement) return 1; },  
 112789: () => { return window.innerWidth; },  
 112815: () => { return window.innerHeight; }
};
